...
def loadData(dataset_root, data_name, cmp_name, input_size):
    ...
    surface_path = fullfile(data_root, "cam/warp/ref")
    cmp_train_path = fullfile(data_root, "cam/warp/cmp")
    prj_train_path = fullfile(data_root, "prj/cmp")
    cmp_valid_path = fullfile(data_root, "cam/warp/cmp")
    prj_valid_path = fullfile(data_root, "prj/cmp")
...
def trainModel(net, train_data, valid_data, train_option, surface_name):
    ...
    checkpoint_file_name = fullfile(
        ...
        f"{surface_name}_{train_option['model_name']}.pth",
    )
