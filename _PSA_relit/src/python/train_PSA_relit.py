...
fine_tune = False
# ckpt_file = './_PSA_relit/checkpoint/blender_APRIF_PCNet_clamp_CmpNeStpp_l1+l2+ssim_10000_32_30000_0.0015_0.8_2000_0.0001.pth'
ckpt_file = "./_PSA_relit/checkpoint/_vset01_APRIF_PCNet_clamp_CmpNeStpp_l1+l2+ssim_1250_32_10000_0.0015_0.8_2000_0.0001.pth"
...
# model_list = ['PSA_relit_PCNet_clamp', 'PSA_relit_PCNet', 'PSA_relit_CompenNeStPlusplus_clamp', 'PSA_relit_CompenNeStPlusplus']

model_list = ["PSA_relit_PCNet_clamp"]
        ...
        for cmp_name in cmp_list:
            ...
            for num_train in num_train_list:
                ...
                for model_name in model_list:
                    # create PSA_relit
                    if model_name == (
                        "PSA_relit_PCNet_clamp" or "PSA_relit_CompenNeStPlusplus_clamp"
                    ):
                        PSA_relit = getattr(Models, model_name)(
                    ...
                    if torch.cuda.device_count() >= 1:
                        PSA_relit = nn.DataParallel(PSA_relit, device_ids=device_ids).to(device)
                    ...
                    for loss in loss_list:
                        ...
                        PSA_relit, valid_psnr, valid_rmse, valid_ssim = trainModel(
                            PSA_relit, train_data, valid_data, train_option, surface_name
                        )
